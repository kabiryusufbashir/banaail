...
@section('body-content')
    <!-- Banner -->
    <div>
        <img class="object-cover w-full sm:h-screen lg:h-auto" src="{{ asset('images/bg-3.jpg') }}" alt="BINAAIL MASAAJID WAL MADAARIS FOUDNDATION">
    ...
    <div class="pt-8 pb-5 text-justify">
        ...
        <div class="bg-white mt-8 pt-8 pb-16">
            ...
            <div class="lg:px-24 px-8 mx-auto">
                <div class="grid grid-cols-3 gap-6 py-2 text-left">
                    <div>
